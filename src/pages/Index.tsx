      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="py-16 md:py-24 flex flex-col items-center justify-center text-center">
          ...
          <p
            ...
            A safe, anonymous platform for VIT students to connect with
            counselors and access mental health resources.
          </p>
          <div
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <BlurCard className="flex flex-col h-full">
            ...
            <p className="text-muted-foreground flex-1">
              Your identity remains completely private. We verify you're a VIT
              student, but your chats are anonymous.
            </p>
          </BlurCard>
          ...
          <BlurCard className="flex flex-col h-full">
            ...
            <p className="text-muted-foreground flex-1">
              Connect with qualified VIT counselors who are dedicated to
          ...
          <BlurCard className="flex flex-col h-full">
            ...
            <p className="text-muted-foreground flex-1">
              Access a curated collection of mental health resources, tips, and
              techniques specifically for students.
            </p>
          </BlurCard>
        </div>
        ...
        <div className="py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We've made the process simple and secure to ensure you get the
              support you need
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Explore our counselors by category and find the right match for
                your needs.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Begin chatting with our AI assistant or request to connect with
                a VIT counselor.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Receive personalized support and resources to help with your
        ...
        <div className="py-16">
          <BlurCard className="text-center p-8 md:p-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
              Your mental wellbeing matters. Connect with a counselor now or
